...
def SeNet(cfg="SeNet18"):
    if cfg=="SeNet18":
        return se_resnet18(num_classes=7)
    elif cfg=="SeNet50":
        return se_resnet34(num_classes=7)
    elif cfg=="SeNet101":
        return se_resnet101(num_classes=7)
    elif cfg=="SeNet152":
        return se_resnet152(num_classes=7)
